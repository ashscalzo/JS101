...
function isDotSeparatedIpAddressOriginal(inputString) {   // Ben's original function
...
// input string has more or less than 4 components, 
// e.g., 4.5.5 or 1.2.3.4.5: both those values should be invalid."
//Help Ben fix his code.

// here is Alyssa's isAnIpNumber function so you can test your code:
...
function isDotSeparatedIpAddress(inputStr) {
  let dotSeparatedWords = inputStr.split('.');
